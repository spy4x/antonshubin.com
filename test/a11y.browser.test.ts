...
// widening that task's permissions.
 ...
 * the same loud failure as test/lead-form.browser.test.ts, so a missing
 * browser fails the build instead of silently skipping this file.
 */
