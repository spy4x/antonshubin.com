...
Deno.test("a one-click unsubscribe (RFC 8058) with the token in the query still works, with or without a body", async () => {
  const bodies = [undefined, "", "List-Unsubscribe=One-Click"];
