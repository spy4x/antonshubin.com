    ...
    <Layout currentPath="/catalog">
      <div class="max-w-3xl mx-auto px-4 py-12">
        ...
        <div class="bg-gray-800 rounded-xl border border-gray-700 p-8">
          ...
          <h2 class="text-lg font-semibold text-white mb-3">What's Included</h2>
          <ul class="space-y-2 mb-6">
            {item.includes.map((inc, j) => (
              <li key={j} class="text-gray-400 flex items-start gap-2">
          ...
          <div class="flex flex-wrap items-center gap-4 pt-6 border-t border-gray-700">
            <a
              href="/contact-me"
              class="inline-flex items-center gap-1.5 px-6 py-3 bg-gradient-to-r from-orange-600 to-amber-500 text-white font-semibold rounded-lg shadow-lg shadow-orange-500/25 hover:scale-105 hover:shadow-xl transition-all duration-200"
            >
              Start this project
            </a>
            <a
